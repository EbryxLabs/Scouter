...
def azure_storage_soft_delete_enabled():
  current_script_name = "azure_storage_soft_delete_enabled"
...
# Retrieve Blob storage details  
      for storage in storage_accounts:
          ...
          for items in blob_service_list:
              blob_info = {
                  ...
                  "Name": items.name,
                  "Soft Delete Enabled": items.delete_retention_policy.enabled if items.delete_retention_policy else None
              }
  ...
  print(f"Blob details have been saved to {output_file}")
