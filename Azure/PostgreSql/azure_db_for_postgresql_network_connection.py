...
def azure_db_for_postgresql_network_connection():
    current_script_name = "azure_db_for_postgresql_network_connection"
        ...
        for group in list(group_list):
            ...
            if response.status_code == 200:
                ...
                for item in data.get("value",[]):
                    ...
                    result_list.append({"server_id":server_id,"server_name":server_name,"server_type":server_type,"publicNetworkAccess":publicNetworkAccess,"privateEndpointConnections":privateEndpointConnections})
