...
def azure_alert_on_policy_assigment():
    
  current_script_name = "azure_alert_on_policy_assigment"
      ...
      for item in data['value']:
        if 'properties' in item and 'condition' in item['properties'] and 'allOf' in item['properties']['condition']:
          for inner_item in item['properties']['condition']['allOf']:
            if inner_item['field'] == 'operationName' and inner_item['equals'] == 'Microsoft.Authorization/policyAssignments/write':
              found = True
